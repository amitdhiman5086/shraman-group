  ...
  return (
    <div>
      ...
      <div className="flex flex-col place-items-center ">
        {/* part1 */}
        <div className="w-[90%] px-10 pt-8 pb-20 rounded-2xl bg-[linear-gradient(to_bottom,_#0D1C9F_0%,_#DE4396_100%)]  ">
        ...
        {/* part2 */}
        <div className="w-[100%]  -mt-10 my-5 rounded-lg  flex justify-center ">
        <iframe
